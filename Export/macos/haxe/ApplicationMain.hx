...
import cornerContourLimeTest.CornerContourLime;
...
@:dox(hide) class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("cornerContourLimeTest.CornerContourLime", create);
	...
	public static function create(config:Dynamic):Void
	{
		...
		#if !munit
		var app = new cornerContourLimeTest.CornerContourLime();
		app.meta.set("build", "3");
		app.meta.set("company", "Nanjizal");
		app.meta.set("file", "cornerContourLimeTest.CornerContourLime");
	...
	public static function start(app:lime.app.Application = null):Void
	{
		...
		new cornerContourLimeTest.CornerContourLime();
