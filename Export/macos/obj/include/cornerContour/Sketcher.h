...
#define INCLUDED_cornerContour_Sketcher
...
class HXCPP_CLASS_ATTRIBUTES Sketcher_obj : public ::hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x441bc2da };

		void __construct(::Dynamic pen_,int sketchForm_,::hx::Null< int >  __o_endLine_);
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="cornerContour.Sketcher")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"cornerContour.Sketcher"); }
...
#endif /* INCLUDED_cornerContour_Sketcher */ 
