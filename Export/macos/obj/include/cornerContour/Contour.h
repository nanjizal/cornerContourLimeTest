...
#define INCLUDED_cornerContour_Contour

#ifndef HXCPP_H
#include <hxcpp.h>
#endif

HX_DECLARE_CLASS1(cornerContour,Contour)
...
class HXCPP_CLASS_ATTRIBUTES Contour_obj : public ::hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x077dda95 };

		void __construct(::Dynamic pen_,::hx::Null< int >  __o_endLine_);
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="cornerContour.Contour")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"cornerContour.Contour"); }
		...
		int circle(Float ax,Float ay,Float radius,::hx::Null< int >  color, ::Dynamic sides, ::Dynamic omega);
		::Dynamic circle_dyn();

		int pie(Float ax,Float ay,Float radius,Float beta,Float gamma, ::fracs::DifferencePreference prefer,::hx::Null< int >  color, ::Dynamic sides);
		::Dynamic pie_dyn();

		int pieX(Float ax,Float ay,Float radius,Float beta,Float gamma, ::fracs::DifferencePreference prefer,::Array< Float > edgePoly,::hx::Null< int >  color, ::Dynamic sides);
		::Dynamic pieX_dyn();

		int pieDifX(Float ax,Float ay,Float radius,Float beta,Float dif,::Array< Float > edgePoly,::hx::Null< int >  color, ::Dynamic sides);
		::Dynamic pieDifX_dyn();
...
#endif /* INCLUDED_cornerContour_Contour */ 
