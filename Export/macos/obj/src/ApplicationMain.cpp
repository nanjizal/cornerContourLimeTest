...
HXLINE(  12)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("cornerContourLimeTest.CornerContourLime",d8,c0,b3,4f),::ApplicationMain_obj::create_dyn());
...
HXLINE(  24)		 ::cornerContourLimeTest::CornerContourLime app =  ::cornerContourLimeTest::CornerContourLime_obj::__alloc( HX_CTX );
HXLINE(  25)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("3",33,00,00,00));
HXLINE(  26)		app->meta->set(HX_("company",3d,15,69,83),HX_("Nanjizal",eb,41,80,78));
HXLINE(  27)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("cornerContourLimeTest.CornerContourLime",d8,c0,b3,4f));
HXLINE(  28)		app->meta->set(HX_("name",4b,72,ff,48),HX_("CornerContourLimeTest",8c,19,d0,c3));
HXLINE(  29)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("net.nanjizal.cornerContourLimeTest",ba,43,ca,02));
...
HXLINE(  34)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("CornerContourLimeTest",8c,19,d0,c3))
