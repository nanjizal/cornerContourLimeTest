...
HX_DEFINE_STACK_FRAME(_hx_pos_7fe85e39c68bc574_47_new,"cornerContourLimeTest.HelpGL","new",0xcd0136ba,"cornerContourLimeTest.HelpGL.new","cornerContourLimeTest/HelpGL.hx",47,0xfa9bf5d5)
namespace cornerContourLimeTest{

void HelpGL_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_7fe85e39c68bc574_47_new)
HXLINE(  55)		this->shaderSetup_ = ::cornerContourLimeTest::_HelpGL::HelpGL_Fields__obj::shaderSetup_dyn();
HXLINE(  52)		this->programSetup_ = ::cornerContourLimeTest::_HelpGL::HelpGL_Fields__obj::programSetup_dyn();
HXLINE(  49)		this->clearAll_ = ::cornerContourLimeTest::_HelpGL::HelpGL_Fields__obj::clearAll_dyn();
            	}
...
bool HelpGL_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x79a3a4f2;
}
...
::hx::ObjectPtr< HelpGL_obj > HelpGL_obj::__alloc(::hx::Ctx *_hx_ctx) {
	HelpGL_obj *__this = (HelpGL_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(HelpGL_obj), true, "cornerContourLimeTest.HelpGL"));
...
void HelpGL_obj::__register()
{
	...
	__mClass->mName = HX_("cornerContourLimeTest.HelpGL",c8,11,c5,ef);
